...
let eventData = {
    '01/01/2002' : 
    [
        {'eventName' : 'ReadyPlayerOneFest','eventDate' : '01/01/2002' , 'eventLocation':'Salem' , 'eventHost':'PlayerOne' , 'lastModified':'01/01/2002'},
        {'eventName' : 'Wolverine','eventDate' : '01/01/2002' , 'eventLocation':'Bengaluru' , 'eventHost':'PlayerOne' , 'lastModified':'01/01/2002'},
    ],
    '08/12/2020' : 
    [
        {'eventName' : 'superman','eventDate' : '08/12/2020' , 'eventLocation':'Bengaluru' , 'eventHost':'henrycavil' , 'lastModified':'01/01/2002'}
    ]
}
...
for(const key in eventData){
    eventData[key].forEach(eachEvent=>{
        ...
        subMenuUi.innerHTML = `<div class="options option1">
                                <div class="icon">
